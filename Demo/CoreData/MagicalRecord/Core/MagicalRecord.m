...
+ (NSString *) currentStack
{
    ...
    [status appendFormat:@"Default Context: %@\n", [[NSManagedObjectContext MR_defaultContextQQ] MR_description]];
    [status appendFormat:@"Context Chain:   \n%@\n", [[NSManagedObjectContext MR_defaultContextQQ] MR_parentChain]];
...
+ (void)setSpecifiedBundle:(NSBundle *)bundle
{
    [NSManagedObjectModel setSpecifidBundle:bundle];
}
